...
var ChasingDots = function ChasingDots(_ref, _ref2) {
  ...
  var color = _ref.color,
      ...
      size = _ref.size,
      props = _objectWithoutProperties(_ref, ['color', 'colorTwo', 'dotSize', 'scaleEnd', 'scaleStart', 'size']);
  ...
  var dotTwo = _extends({}, dot, (0, _util.animate)({ delay: '-1.0s' }), {
    backgroundColor: colorTwo || color || betterReactSpinkit.color || _util.defaults.color,
    bottom: 0,
    top: 'auto'
  });
...
ChasingDots.propTypes = {
   ...
   */
  colorTwo: _propTypes2.default.string,
  /**
